...
use WPWCoreMonolog\Test\TestCase;
...
class SyslogUdpHandlerTest extends TestCase
{
    ...
    public function testWeSplitIntoLines()
    {
        ...
        $handler = new \WPWCoreMonolog\Handler\SyslogUdpHandler("127.0.0.1", 514, "authpriv");
        $handler->setFormatter(new \WPWCoreMonolog\Formatter\ChromePHPFormatter());
    ...
    public function testRfc()
    {
        ...
        $handler = $this->getMockBuilder('\Monolog\Handler\SyslogUdpHandler')
            ->setConstructorArgs(["127.0.0.1", 514, "authpriv", 'debug', true, "php", \WPWCoreMonolog\Handler\SyslogUdpHandler::RFC3164])
            ->onlyMethods([])
            ->getMock();
